...
const ReservationForm = () => {
  return (
    <div className="bg-green-700 p-6 rounded-lg">
      <GrRestaurant className="w-[5rem] h-[5rem] text-white mx-auto mt-[2rem]" />
      ...
      <div className="mt-[2rem]">
        ...
        <div className="mt-[2rem] w-[80%] text-center mx-auto">
          <button className="px-8 py-3 mb-[3rem] text-[16px] rounded-lg w-full bg-blue-950 transition-all duration-300 hover:bg-blue-600 text-white">
            Book Now
          </button>
        </div>
      </div>
